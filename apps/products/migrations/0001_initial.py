    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, '编辑中'), (1, '已上架'), (2, '已下架')], default=0, verbose_name='兑换产品状态')),
                ...
                ('product_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.ProductType', verbose_name='类型')),
            ],
            options={
                'verbose_name': '产品',
